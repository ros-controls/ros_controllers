...
{
LowPassDerivative::LowPassDerivative(double filter_param) : filter_param_(filter_param)
{
}

double LowPassDerivative::differentiate(const double new_msrmt)
{
/*
...
*/
  ...
  double new_filtered_msrmt = new_msrmt;
  return new_filtered_msrmt;
}

void LowPassDerivative::reset(double data)
{
